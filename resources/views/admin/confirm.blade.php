...
<head>
  ...
  <title>Payment Confirmation | Dit Cooperative</title>
              ...
              @if ($member->confirmed_for_payment === 0)
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <button type="button" {{ count($member->referrals) < 2 ? 'disabled' : '' }} class="btn btn-success btn-sm" data-bs-toggle="{{ count($member->referrals) < 2 ? '' : 'modal' }}" data-bs-target="#approvalForPayment">
                            Confirm Payment 
                        </button>
                    </td>
                </tr>
...
<div class="modal fade" id="approvalForPayment" tabindex="-1" aria-labelledby="approvalForPaymentLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <form id="confirmForm" action="/admin.confirm" method="POST">
